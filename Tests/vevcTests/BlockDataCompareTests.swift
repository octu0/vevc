...
final class BlockDataCompareTests: XCTestCase {
    ...
    func testLayer32BlocksMatch() async throws {
        ...
        let (layer2Bytes, _, _, encYBlocks, _, _) = try await encodePlaneLayer32(pd: pd, predictedPd: nil, layer: 2, qtY: qtY, qtC: qtC, zeroThreshold: 3)
        ...
        let decYBlocks = try decodePlaneSubbands32(data: bufY, blockCount: rowCountY * colCountY)
