...
final class QuantRoundtripTests: XCTestCase {
    ...
    func testSignedMappingRoundTrip16x16_Step1() {
        ...
        quantize16(block, q: qt.qLow)
        dequantize16(ptr: block.base, stride: block.stride, q: qt.qLow)
    ...
    func testSignedMappingRoundTrip32x32_Step1() {
        ...
        quantize32(block, q: qt.qLow)
        dequantize32(block, q: qt.qLow)
    ...
    func testMidHighSignedMappingRoundTrip() {
        ...
        quantize8(blockMid, q: qt.qMid)
        dequantize8(ptr: blockMid.base, stride: blockMid.stride, q: qt.qMid)
        ...
        quantize8(blockHigh, q: qt.qHigh)
        dequantize8(ptr: blockHigh.base, stride: blockHigh.stride, q: qt.qHigh)
