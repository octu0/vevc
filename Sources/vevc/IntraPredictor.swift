...
@inline(__always)
func intraPredictorPredict(
    mode: IntraPredictorMode,
    block: inout [Int16],
    width: Int,
    height: Int,
    top: [Int16]?,
    ...
    switch mode {
    case .dc:
        intraPredictDC(block: &block, width: width, height: height, top: top, left: left)
    case .vertical:
        intraPredictVertical(block: &block, width: width, height: height, top: top)
    case .horizontal:
        intraPredictHorizontal(block: &block, width: width, height: height, left: left)
    case .planar:
        intraPredictPlanar(block: &block, width: width, height: height, top: top, left: left, topLeft: topLeft)
    }
}

@inline(__always)
private func intraPredictDC(block: inout [Int16], width: Int, height: Int, top: [Int16]?, left: [Int16]?) {
    var sum: Int32 = 0
    var count: Int32 = 0
...
@inline(__always)
private func intraPredictVertical(block: inout [Int16], width: Int, height: Int, top: [Int16]?) {
    guard let t = top, t.count >= width else {
        intraPredictDC(block: &block, width: width, height: height, top: top, left: nil)
        return
    }
...
@inline(__always)
private func intraPredictHorizontal(block: inout [Int16], width: Int, height: Int, left: [Int16]?) {
    guard let l = left, l.count >= height else {
        intraPredictDC(block: &block, width: width, height: height, top: nil, left: left)
        return
    }
...
@inline(__always)
private func intraPredictPlanar(block: inout [Int16], width: Int, height: Int, top: [Int16]?, left: [Int16]?, topLeft: Int16) {
